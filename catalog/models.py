...
class Country(models.Model):
    ...
    image = models.ImageField(upload_to="countries/", blank=True,default="image-placeholder.jpeg")
...
class Manufacturer(models.Model):
    ...
    photo = models.ImageField(upload_to="manufacturers/",blank=True,default="photo-placeholder.jpeg")
...
class Category(models.Model):
    name = models.CharField(max_length=50)
    photo = models.ImageField(upload_to="categories/",blank=True,default="category-placeholder.jpeg")
...
class Product(models.Model):
    ...
    image = models.ImageField(upload_to="product/", blank=True, default="product-placeholder.jpeg")
