...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AlterField(
            model_name='author',
            name='photo',
            field=models.ImageField(blank=True, default='photo-placeholder.jpeg', upload_to='authors/'),
        ),
        migrations.AlterField(
            model_name='book',
            name='image',
            field=models.ImageField(blank=True, default='product-placeholder.jpeg', upload_to='books/'),
        ),
        migrations.AlterField(
            model_name='genre',
            name='image',
