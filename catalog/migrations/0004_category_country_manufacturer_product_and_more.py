    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=50)),
                ('image', models.ImageField(blank=True, default='image-placeholder.jpeg', upload_to='countries/')),
            ],
        ),
        migrations.CreateModel(
            name='Manufacturer',
            fields=[
                ...
                ('photo', models.ImageField(blank=True, default='photo-placeholder.jpeg', upload_to='manufacturers/')),
            ],
        ),
        migrations.CreateModel(
            name='Product',
            fields=[
                ...
                ('image', models.ImageField(blank=True, default='product-placeholder.jpeg', upload_to='product/')),
